...
function tb_show(caption, url, imageGroup, callback, options) {//function called when the user clicks on a thickbox link
	if (typeof options!='object') {
		var options = {onremoved: false, closeButton: '#TB_closeWindowButton'};
	}else{
		options.onremoved = options.onremoved || false;
		options.closeButton= options.closeButton+', #TB_closeWindowButton' || '#TB_closeWindowButton';
	}
	console.log(options)
	...
	try {
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			// $('#TB_title'options.).click(function(){tb_remove(false); return false;});
			$(options.closeButton).click(function(){tb_remove(false,options.onremoved);return false;});
			if (!(TB_PrevHTML === "")) {
				function goPrev(){
...
function tb_remove(reload, onremoved) {
