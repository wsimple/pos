...
<div id="receipt_wrapper">
	...
	<tr>
		<td colspan="4" style="text-align:right;border-top:2px solid #000000;">
			<?php echo $this->lang->line('customers_customer').' '.$this->lang->line('customers_lbl_td_discount') ?>(<?php echo $general_discount ?>%):
		</td>
		<td colspan="2" style="text-align:right;border-top:2px solid #000000;">
			<?php echo to_currency($subtotal*$general_discount/100) ?>
		</td>
	</tr>
	<?php endif ?>
